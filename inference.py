...
try:
    ...
    print("YOLO imported successfully.", flush=True)
except Exception as e:
    print(f"Error importing YOLO: {e}", flush=True)
    sys.exit(1)
...
def main():
    ...
    parser.add_argument('--project', type=str, default=str(Path.cwd() / 'runs' / 'predict'))
